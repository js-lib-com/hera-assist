...
public class ActionsFulfillmentTest
{
  ...
  {
    DeviceHandler[] handlers = actions.getDeviceHandlers();
    ...
    assertThat(handlers[0].getHostName(), equalTo("actuators"));
    ...
    assertThat(handlers[1].getHostName(), equalTo("dht-sensor"));
    ...
    assertThat(handlers[2].getHostName(), equalTo("dht-sensor"));
    ...
    assertThat(handlers[3].getHostName(), equalTo("thermostat"));
